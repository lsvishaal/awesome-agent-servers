...
<h1 align="center">competitor-analysis-agent</h1>
<h3 align="center">Competitive intelligence agent using Firecrawl (search/crawl/map) + ReasoningTools to generate a structured competitor analysis report.</h3>

<p align="center">
  <strong>Competitive intelligence agent using Firecrawl (search/crawl/map) + ReasoningTools to generate a structured competitor analysis report.</strong><br/>
  Competitive intelligence agent using Firecrawl (search/crawl/map) + ReasoningTools to generate a structured competitor analysis report.
</p>

<p align="center">
  <a href="https://github.com/lsvishaal/competitor-analysis-agent/actions/workflows/main.yml?query=branch%3Amain">
    <img src="https://img.shields.io/github/actions/workflow/status/lsvishaal/competitor-analysis-agent/main.yml?branch=main" alt="Build status">
  </a>
  <a href="https://codecov.io/gh/lsvishaal/competitor-analysis-agent">
    <img src="https://codecov.io/gh/lsvishaal/competitor-analysis-agent/branch/main/graph/badge.svg" alt="codecov">
  </a>
  <a href="https://img.shields.io/github/license/lsvishaal/competitor-analysis-agent">
    <img src="https://img.shields.io/github/license/lsvishaal/competitor-analysis-agent" alt="License">
  </a>
</p>
...
**Perfect for:** Competitive intelligence agent using Firecrawl (search/crawl/map) + ReasoningTools to generate a structured competitor analysis report.
...
- 📖 **[Full Documentation](https://lsvishaal.github.io/competitor-analysis-agent/)**
- 💻 **[GitHub Repository](https://github.com/lsvishaal/competitor-analysis-agent/)**
- 🐛 **[Report Issues](https://github.com/lsvishaal/competitor-analysis-agent/issues)**
...
gh repo create lsvishaal/competitor-analysis-agent --public --source=. --remote=origin --push
```
...
3. Then run:
```bash
git remote add origin https://github.com/lsvishaal/competitor-analysis-agent.git
...
├── competitor_analysis_agent/    # Main agent code
│   ├── skills/             # Agent capabilities
│   │   └── competitor_analysis_agent/ # competitor-analysis-agent skill
│   └── __init__.py
├── tests/                  # Test suite
├── docs/                   # Documentation
...
<p align="center">
  <a href="https://github.com/lsvishaal/competitor-analysis-agent">⭐ Star this repo</a> •
